...
# --- FIX APPLIED HERE ---
# Use sed to replace the non-existent 'numpy==1.27.5' with 'numpy' (latest valid)
# This prevents the "No matching distribution" error.
RUN if [ -f requirements.txt ]; then \
    sed -i 's/numpy==1.27.5/numpy/g' requirements.txt; \
    fi
# ------------------------
